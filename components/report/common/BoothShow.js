...
class BoothShow extends Component {
    ...
    render() {
        return (
            ...
            >
                <Text>
                    {this.props.data.description.describle}
                </Text>
                <Rating
                    showRating
                    type="star"
                ...
                />
                <Text>
                    Số người tham gia: {this.props.data.description.attend}
                </Text>
                <Text>
                    Số người quan tâm: {this.props.data.description.care}
                </Text>
                <Text>
                    Số chuyên gia: {this.props.data.description.expert}
                </Text>
                <Text>
