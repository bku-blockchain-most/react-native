      ...
      <Container>
        <List>
          <Item>
            ...
            <Input placeholder="Enter your name" value={this.state.name} onChangeText={name => this.setState({name})} />
          </Item>

          <Item>
            <Text style={{width: 80, marginLeft: 5}}>Email</Text>
            <Input placeholder="Enter your email" value={this.state.email} onChangeText={email => this.setState({email})} />
          </Item>

          <Item>
            <Text style={{width: 80, marginLeft: 5}}>Major</Text>
            <Input placeholder="Enter your major" value={this.state.major} onChangeText={major => this.setState({major})} />
          </Item>

          <Item>
            <Text style={{width: 80, marginLeft: 5}}>Phone</Text>
            <Input placeholder="Enter your phone" value={this.state.phone} onChangeText={phone => this.setState({phone})} />
          </Item>

          <Item>
            <Text style={{width: 80, marginLeft: 5}}>Company</Text>
            <Input placeholder="Enter your company" value={this.state.company} onChangeText={company => this.setState({company})} />
          </Item>

          <Form>
            <Textarea rowSpan={5} bordered placeholder="Note" value={this.state.note} onChangeText={note => this.setState({note})} />
          </Form>
